...
public class WeatherTools {
    ...
    public WeatherTools(RestClient.Builder builder) {
        this.restClient = builder
                ...
                .defaultHeader("User-Agent", "WeatherApiClient/1.0 (youssefaitbahssine23@email.com)")
                .build();
    }
     ...
     * @throws RestClientException if the request fails
     */
    @Tool(description = "Get weather alerts for a Marrakech state. Input is Two-letter  code (e.g. CA, NY)")
